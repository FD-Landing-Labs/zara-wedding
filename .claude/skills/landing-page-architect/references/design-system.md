...
className =
  "text-[clamp(2.5rem,5vw+1rem,5rem)] font-bold tracking-tighter leading-[1.1]";

// H1
className =
  "text-[clamp(2rem,4vw+0.5rem,3.75rem)] font-bold tracking-tighter leading-[1.15]";

// H2 Section title
className =
  "text-[clamp(1.5rem,3vw+0.5rem,2.5rem)] font-semibold tracking-tighter leading-[1.2]";

// H3 Subsection
className =
  "text-[clamp(1.25rem,2vw+0.25rem,1.75rem)] font-medium leading-[1.3]";

// Body large (hero descriptions)
className =
  "text-lg md:text-xl text-muted-foreground leading-relaxed tracking-tight";

// Body
className = "text-base text-muted-foreground leading-relaxed tracking-tight";
...
```
Display/H1:  -0.1em (tracking-tight)
H2/H3:       -0.1em
Body:        0 (normal)
...
// Brand border glow
className =
  "border border-primary/20 shadow-[0_0_15px_rgba(var(--primary),0.1)]";
```
